...
const UserRegister = (props) => {
    ...
    return (
      <section>
        <div className="relative w-full h-full flex flex-row mx-auto md:h-screen lg:py-0 animate-slide-in-2 overflow-hidden">
          <div className="relative flex-shrink-0 w-1/2 "></div>
          <div className="relative flex-shrink-0 w-1/2 overflow-hidden">
            <div
              className="relative flex h-screen items-center justify-center bg-gray-700 bg-opacity-75 rounded-tl-3xl rounded-bl-3xl overflow-hidden"
              style={{
                backgroundImage:
            ...
            >
              <div className="absolute overflow-hidden w-3/4 md:w-1/2 h-10/12 p-6 space-y-4 md:space-y-6 sm:p-8">
                  ...
                  >
                    <div>
                      <input
                        ...
                        name="username"
                        id="username"
                        className="items-center justify-center border-b-2 border-[#FFF5E0] bg-transparent text-[#FFF5E0] placeholder-[#FFF5E0] text-xl placeholder-text-lg sm:text-sm rounded-sm w-10/12 p-2.5 outline-none"
                    ...
                    <div>
                      <input
                        ...
                        name="email"
                        id="email"
                        className="items-center justify-center border-b-2 border-[#FFF5E0] bg-transparent text-[#FFF5E0] placeholder-[#FFF5E0] sm:text-sm rounded-sm w-10/12 p-2.5 outline-none"
                        placeholder="E-mail"
                        {...register("email")}
                        required
                      />
