                  ...
                  >
                    <div className='pt-1.5'>
                      <input
                        ...
                        name="username"
                        id="username"
                        className="items-center justify-center border-b-2 border-[#FFF5E0] bg-transparent text-[#FFF5E0] placeholder-[#FFF5E0] md:text-lg sm:text-sm rounded-sm w-10/12 p-2.5 outline-none"
                    ...
                    <button
                      type="submit"
                      className="items-center justify-center bg-[#FFF5E0] md:text-lg sm:text-sm rounded-lg w-1/2 p-1.5"
                    >
                      Register
                    </button>
                  </form>
