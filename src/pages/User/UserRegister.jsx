...
const UserRegister = (props) => {
  ...
  const submit = async (data) => {
    axios
      .post("https://se-project-backend-bbf.onrender.com/auth/register", data)
      .then((res) => {
        console.log(res);
                ...
                >
                  <div className='pt-1.5'>
                    <input
                      ...
                      name="username"
                      id="username"
                      className="items-center justify-center border-b-2 border-[#FFF5E0] bg-transparent text-[#FFF5E0] placeholder-[#FFF5E0] text-xs md:text-lg sm:text-base w-10/12 pb-0 md:pb-1 outline-none"
                  ...
                  <button
                    type="submit"
                    className="items-center justify-center bg-[#FFF5E0] text-xs  md:text-lg sm:text-sm rounded-lg w-1/2 p-1 md:p-1.5 outline-none"
                  >
                    Register
                  </button>
                </form>
