    ...
    const submit = async (data) => {
        ...
        axios
            ...
            .then((res) => {
                ...
                sessionStorage.setItem("UserDetails", res && res.data ? JSON.stringify(res.data.profile) : {});
            ...
            <div className='flex-shrink-0 w-1/2'>
                <div className='flex h-screen items-center justify-center bg-gray-700 bg-opacity-75 rounded-tl-3xl rounded-bl-3xl'>
                    ...
                    > */}
                        ...
                        {/* <div className="w-1/2 h-10/12 p-6 space-y-4 md:space-y-6 sm:p-8"> */}
                            {/* <h1 className="text-xl text-center font-bold leading-tight tracking-tight text-[#FFF5E0] md:text-2xl dark:text-white">
                            ...
                            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(submit)}>
                                <div>
                                    ...
                                    <input type="text"
                                        name="username"
                                        id="username"
                                        className="items-center justify-center border-b-2 border-[#FFF5E0] bg-transparent text-[#FFF5E0] placeholder-[#FFF5E0] text-xl placeholder-text-lg sm:text-sm rounded-sm w-10/12 p-2.5" placeholder="Username"
                                        {...register("username")}
                                        required />
                                </div>
                                <div>
                                    ...
                                    <input type="text"
                                        name="email"
                                        id="email"
                                        className="items-center justify-center border-b-2 border-[#FFF5E0] bg-transparent text-[#FFF5E0] placeholder-[#FFF5E0] sm:text-sm rounded-sm w-10/12 p-2.5" placeholder="E-mail"
                                        {...register("email")}
                                        required />
                                </div>
                                <div>
                                    ...
                                    <input type="password"
                                        ...
                                        className="items-center justify-center border-b-2 border-[#FFF5E0] bg-transparent text-[#FFF5E0] placeholder-[#FFF5E0] sm:text-sm rounded-sm w-10/12 p-2.5"
                                        {...register("password")}
                                        required />
                                </div>
                                <button
                                    type="submit"
                                    className="items-center justify-center bg-[#FFF5E0] sm:text-sm rounded-lg w-1/2 p-1.5"
                                >
                                    Register
                                </button>
