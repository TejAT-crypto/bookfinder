      ...
      <section>
        <div className="relative w-full h-full flex flex-row mx-auto md:h-screen lg:py-0 animate-slide-in-2 overflow-hidden">
          ...
          <div className="relative flex-shrink-0 w-1/2 overflow-hidden">
            <div
              className="relative backdrop-blur-sm flex h-screen items-center justify-center bg-black bg-opacity-25 rounded-tl-3xl rounded-bl-3xl overflow-hidden"
              style={{
                backgroundImage:
                  ...
                  >
                    <div className='pt-1.5'>
                      <input
                        ...
                        name="email"
                        id="email"
                        className="items-center justify-center border-b-2 border-[#FFF5E0] bg-transparent text-[#FFF5E0] placeholder-[#FFF5E0] md:text-xl sm:text-sm rounded-sm w-10/12 p-2.5 outline-none"
                        placeholder="E-mail"
                        {...register("email")}
                        required
                      />
                    ...
                    <button
                      type="submit"
                      className="items-center justify-center bg-[#FFF5E0] md:text-xl sm:text-sm rounded-lg w-1/2 p-1.5"
                    >
                      Login
                    </button>
                  </form>
