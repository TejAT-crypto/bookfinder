        ...
        <nav class="bg-[#fff5e0]">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <button type="button" class="flex text-sm bg-[#fff5e0] rounded-full md:me-0" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-[#fff5e0] md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-[#fff5e0] dark:bg-[#fff5e0]">
                        <li>
                            <a href="#" class="block py-2 px-3 text-blue-500 bg-blue-700 rounded md:bg-transparent md:text-[#141E46] md:hover:text-[#141E46] md:p-0 md:dark:text-blue-500" aria-current="page">Discussion</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-3 text-blue-500 rounded hover:text-[#141E46] md:hover:bg-transparent md:hover:text-[#141E46] md:p-0">Chat</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-3 text-blue-500 rounded hover:text-[#141E46] md:hover:bg-transparent md:hover:text-[#141E46] md:p-0 ">Activity</a>
                        </li>
                    </ul>
                </div>
            </div>
